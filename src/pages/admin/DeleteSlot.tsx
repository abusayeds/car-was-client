...
import {  useDeleteSlotMutation } from "../../redux/features/admin/adminApi";

const DeleteSlot = ({ deleteData, onClose }: any) => {
  const [deleteSlot] = useDeleteSlotMutation()
  const [toastMessage, setToastMessage] = useState<string | null>(null);
  if (!deleteData.openSlotDeleteModal) {
    return null;
  }
  ...
  const hendleDelete = async () => {
    console.log(deleteData.deleteSlotId);
    
    try {
      const res: any = await deleteSlot(deleteData.deleteSlotId);
